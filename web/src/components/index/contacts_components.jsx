    ...
    return(
        <div className="p-24">
            ...
            <div className='hidden md:block'>
                <div className="mt-24 flex md:items-center justify-center bg-neutral-700 w-96 md:w-auto rounded-lg">
                    <div className="p-5">
                        <div className="flex flex-col space-y-10 items-center justify-center">
                            <span className="text-white font-bold">contact@arobase.fr</span>
                            <div className="">
                                <form className="flex flex-col md:flex-row space-y-5 md:space-y-0 md:space-x-2">
